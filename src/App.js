...
function App() {
  const enemyChampions = [
    ...
    { index: 3, team: 'enemy', hexagonPosition: { left: 1, top: 1 }, currentPosition: { left: convertToPixels(1, 'left', true) - 25, top: convertToPixels(1, 'top', true) - 25 }, image: "https://prod.api.assets.riotgames.com/public/v1/asset/lol/13.24.1/CHAMPION_SKIN/223020/SPLASH?width=1920&height=1080&format=auto&auto=webp", type: "tahm-kench", starLevel: 2, headliner: false, items: [], alive: true, attackRange: 1, health: 1000, attackDamage: 75, attackSpeed: 30, totalMana: null, mana: null, abilityPower: 100, armor: 20, magicResist: 20, castingAttack: false, castingAbility: false, projectiles: [], abilityCastTime: null, movementSpeed: 30, iterationsRemaining: { attack: 17, ability: null, move: 30 }, attackProjectileSpeed: 0, abilityProjectileSpeed: null },
  ];

  const userChampions = [
    { index: 0, team: 'user', hexagonPosition: { left: 4, top: 4 }, currentPosition: { left: convertToPixels(4, 'left', false) - 25, top: convertToPixels(4, 'top', false) - 25 }, image: "https://prod.api.assets.riotgames.com/public/v1/asset/lol/13.24.1/CHAMPION_SKIN/223020/SPLASH?width=1920&height=1080&format=auto&auto=webp", type: "tahm-kench", starLevel: 1, headliner: false, items: [], alive: true, attackRange: 1, health: 700, attackDamage: 50, attackSpeed: 30, totalMana: null, mana: null, abilityPower: 100, armor: 20, magicResist: 20, castingAttack: false, castingAbility: false, projectiles: [], abilityCastTime: null, movementSpeed: 30, iterationsRemaining: { attack: 17, ability: null, move: 30 }, attackProjectileSpeed: 0, abilityProjectileSpeed: null },
